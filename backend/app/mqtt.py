...
class MQTT:
    ...
    sub_topics = [("620151149_pub", 0), ("620151149", 0), ("620151149_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620151149", self.update) 
        # self.client.message_callback_add("620151149_sub", self.toggle)
